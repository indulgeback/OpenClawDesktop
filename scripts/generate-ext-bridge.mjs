#!/usr/bin/env node
/**
 * Generates extension bridge files based on openclawpro-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'openclawpro-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure openclawpro-extensions.json and link the package.',
