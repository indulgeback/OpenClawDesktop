...
const LOCALHOST_FALLBACK_FLAG = 'openclawpro:allow-localhost-fallback';
const SSE_FALLBACK_FLAG = 'openclawpro:allow-sse-fallback';
const WS_DIAGNOSTIC_FLAG = 'openclawpro:gateway-ws-diagnostic';
