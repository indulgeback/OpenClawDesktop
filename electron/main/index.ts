...
const isE2EMode = process.env.OPENCLAWPRO_E2E === '1';
const requestedUserDataDir = process.env.OPENCLAWPRO_USER_DATA_DIR?.trim();
...
function createWindow(): BrowserWindow {
  ...
  const shouldSkipSetupForE2E = process.env.OPENCLAWPRO_E2E_SKIP_SETUP === '1';
