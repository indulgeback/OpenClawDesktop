...
export async function sanitizeOpenClawConfig(): Promise<void> {
  return withConfigLock(async () => {
    ...
    // When OpenClawPro-managed moonshot provider exists, prefer centralized key
    ...
    // but OpenClawPro historically stored them only under `channels.<type>.accounts.default`.
