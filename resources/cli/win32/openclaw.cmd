...
if /i "%1"=="update" (
    echo openclaw is managed by OpenClawPro ^(bundled version^).
    echo.
    echo To update openclaw, update OpenClawPro:
    echo   Open OpenClawPro ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=OpenClawPro
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\OpenClawPro.exe" "%OPENCLAW_ENTRY%" %*
)
