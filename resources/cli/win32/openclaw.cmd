...
if /i "%1"=="update" (
    echo openclaw is managed by OpenClaw ^(bundled version^).
    echo.
    echo To update openclaw, update OpenClaw:
    echo   Open OpenClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=OpenClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\OpenClaw.exe" "%OPENCLAW_ENTRY%" %*
)
